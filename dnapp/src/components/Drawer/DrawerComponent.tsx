...
type DrawerComponentProps = DrawerItemsProps & ReturnType<typeof mapStateToProps>;
			...
			<View style={styles.drawerContainer}>
				...
				<ScrollView style={{ flex: 1, backgroundColor: '#fff' }}>
					<View style={styles.drawerHeader}>
						<Text style={styles.drawerHeaderText}>Welcome{name ? ', ' + name : ''}</Text>
					</View>
					<DrawerItem
						onPress={() => { navigation.navigate("AddressSearch") }}
						text="Keren Lines, Delhi Cantonment, New Delhi"
						leftIcon={<EvilIcons name="location" color="rgba(0,0,0,0.7)" size={22} />}
						rightIcon={<EvilIcons color="rgba(0,0,0,0.7)" name="pencil" size={22} />}
					/>
					{loggedIn ? (
						<DrawerItem
							onPress={() => {
							...
							text="My Account"
							leftIcon={<FontAwesome name="user-o" color="rgba(0,0,0,0.7)" size={14} />}
						/>
					) : (
							<DrawerItem
								onPress={() => {
					...
					<DrawerItem
						...
						leftIcon={<AntDesign name="tago" color="rgba(0,0,0,0.7)" size={16} />}
					/>
					<DrawerItem
						onPress={() => {navigation.navigate("Orders")}}
						leftIcon={<Entypo name="list" color="rgba(0,0,0,0.2)" size={14} />}
						text="My Orders"
					/>
					<DrawerItem
						leftIcon={
					...
					<DrawerItem
						...
						leftIcon={
							<MaterialCommunityIcons name="lifebuoy" color="rgba(0,0,0,0.6)" size={14} />
						}
					/>
					<DrawerItem
						leftIcon={
